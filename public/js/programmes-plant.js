...
$(document).ready(function (){
	...
	/*
	* js spinner for when things like saving are slow
	*/
	var opts = {
	...
	// if you add class="spinner" to any button in a modal, the spinner will appear over the modal when that button is pressed
	$(".spinner").click(function(){
		var spinner = new Spinner(opts).spin($(this)[0].parentNode.parentNode);
	});
