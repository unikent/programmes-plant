<?php
/*
	A simple helper to make 'things' xml valid
*/

class XMLHelper {

	// from http://stackoverflow.com/questions/11176752/converting-named-html-entities-to-numeric-html-entities
	public static $HTML401NamedToNumeric = array(
	...
	public static function addXHTMLPrefix($text){
		$result = preg_replace("/<(\/*)(.+?)>/", "<$1xhtml:$2>", $text);
		return $result ;
	}

	public static function fixRelativeURLs($text){
		$result = preg_replace("/href=\"\/(.+?)\"/", "href=\"http://kent.ac.uk/$1\"", $text);
		return $result ;
	}

	public static function htmlTrim($text){
		return trim(str_replace('&nbsp;', ' ', $text));
	}

	public static function stripTags($text)
	{
		return strip_tags($text, '<p><h1><h2><h3><h4><h5><h6><div><ul><li><ol><dl><pre><hr><blockquote><address><fieldset><table><form><a><br><bdo><map><object><img><tt><i><b><big><small><em><strong><dfn><code><q><samp><kbd><var><cite><abbr><acronym><sub><sup><input><select><textarea><label><button><noscript><ins><del><script>');
	}
