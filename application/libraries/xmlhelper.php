...
class XMLHelper {
	...
	public static function sanitizeTagsAndAttributes($text)
	{
		...
		// Array of attributes to remove, all others will be kept
		$attributes_to_remove = array('target', 'onClick', 'style', 'trebuchet', 'align="left"', 'value');

		// Get an array of all the attributes and their values in the data string
		preg_match_all('/[a-z]+=".*?"/i', $result, $attributes);
