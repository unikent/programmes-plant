  ...
  <p><?php echo  __('programmes.rev_pre_live_intro'); ?></p>


  <table class="table table-striped table-bordered">
    <thead>
      <th></th>
      <th><?php echo  __('programmes.rev_table_proposed_header', array('ident_str' => $diff['revision_1']->get_identifier_string())); ?></th>
    </thead>
    <tbody>
