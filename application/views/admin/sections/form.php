  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row-fluid">
        ...
        <div class="span9 crud">
          ...
          <?php echo Form::open('/sections/'.( $create ? 'create' : 'edit' ), 'POST', array('class'=>'form-horizontal'));?>
            ...
            <div class="form-actions">
              <a class="btn" href="<?php echo url('/sections')?>">Go Back</a>
    ...
    <div class="modal hide fade" id="delete_section">
      ...
      <div class="modal-footer">
        <?php echo Form::open('section/delete', 'POST')?>
