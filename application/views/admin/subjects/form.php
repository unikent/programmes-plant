...
<?php endif; ?>
  ...
  <div class="control-group">
      <?php echo Form::label('jacs_codes', __('subjects.form.jacs_code.label'), array('class'=>'control-label'))?>
      <div class="controls">
        <?php echo Form::text('jacs_codes',  ( Input::old('jacs_codes') || $create ? Input::old('jacs_codes') : $item->jacs_codes ),array('placeholder' => __('subjects.form.jacs_code.placeholder')))?>
      </div>
    </div>
