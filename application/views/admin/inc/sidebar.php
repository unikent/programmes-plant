<div class="navwell">
  <ul class="nav nav-list">
        ...
        <?php if (Auth::user()->can("edit_data")): ?>
            ...
            <li class="<?php echo ( URI::segment(3) == 'awards' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'awards')?>"><i class="icon-list-alt"></i> Awards</a></li>
            <li class="<?php echo ( URI::segment(3) == 'campuses' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'campuses')?>"><i class="icon-list-alt"></i> Campuses</a></li>
            <li class="<?php echo ( URI::segment(3) == 'faculties' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'faculties')?>"><i class="icon-list-alt"></i> Faculties</a></li>
            <li class="<?php echo ( URI::segment(3) == 'leaflets' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'leaflets')?>"><i class="icon-list-alt"></i> Leaflets</a></li>
            <li class="<?php echo ( URI::segment(3) == 'schools' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'schools')?>"><i class="icon-list-alt"></i> Schools</a></li>
            <li class="<?php echo ( URI::segment(3) == 'subjects' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'subjects')?>"><i class="icon-list-alt"></i> Subjects</a></li>
            <li class="<?php echo ( URI::segment(3) == 'subjectcategories' ? 'active' : false )?>"><a href="<?php echo url(URLParams::$mainpath.'subjectcategories')?>"><i class="icon-list-alt"></i> Subject categories</a></li>
        <?php endif; ?>
        ...
        <li class="<?php echo ( (URI::segment(2) == 'fields' && URI::segment(3) == 'globalsettings') ? 'active' : false )?>"><a href="<?php echo url(URLParams::$type.'/fields/globalsettings')?>"><i class="icon-cog"></i> Immutable fields </a></li>
