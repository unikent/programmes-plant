  ...
  <ul class="nav nav-list">
        ...
        <?php if (Auth::user()->can("edit_data")): ?>
		  ...
		  <li class="nav-header">UG Data</li>
			...
			<li class="<?php echo ( URI::segment(1) == 'subjectcategories' ? 'active' : false )?>"><a href="<?php echo url('ug/subjectcategories')?>"><i class="icon-list-alt"></i> PG Subject categories</a></li>
			<?php if (Auth::user()->can("edit_overridable_data")): ?>
