<div class="navwell">
  <ul class="nav nav-list">
        ...
        <?php if (Auth::user()->can("configure_fields")): ?>
            ...
            <li class="<?php echo ( (URI::segment(2) == 'fields' && URI::segment(3) == 'globalsettings') ? 'active' : false )?>"><a href="<?php echo url('fields/globalsettings')?>"><i class="icon-cog"></i> Immutable fields </a></li>
