<h2>Revisions</h2>
          <p>The following are revisions of this global setting.</p>
          <table class="table table-striped table-bordered table-condensed">
            ...
            <?php foreach ($revisions as $revision) : ?>
              <tr>
                ...
                <td>
                  <a class="popup_toggler btn btn-success" href="#make_revision_live" rel="<?php echo  action(URI::segment(1).'/'.URI::segment(2).'/globalsettings@make_live', array($revision->id)) ?>">Make Live</a>
                  <a class="popup_toggler btn btn-warning" href="#revert" rel="<?php echo  action(URI::segment(1).'/'.URI::segment(2).'/globalsettings@revert_to_revision', array($revision->id)) ?>">Revert To Revision</a>

                  <a class="btn btn-info" href="<?php echo  action(URI::segment(1).'/'.URI::segment(2).'/globalsettings@difference', array($revision->id)) ?>">Difference</a>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
