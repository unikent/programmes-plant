...
class Add_Globals {
	...
	public function up()
	{
		...
		$this->addField('global','KIS Instition ID','text','','');
		$this->addField('global','Apply Content','textarea','','');
		$this->addField('global','Fees Content','textarea','','');
		$this->addField('global','Additional entry requirment information','textarea','','');
